        ...
        <Card className="border-2">
          <CardHeader className="text-center space-y-4">
            ...
            <CardDescription className="text-base">
              Join ValuAI to get professional business valuations and investor-ready reports
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                {formData.password && (
                  <div className="space-y-1 text-xs">
                    ...
                    <div className={`flex items-center space-x-2 ${passwordValidation.hasUpperCase && passwordValidation.hasLowerCase ? 'text-success' : 'text-muted-foreground'}`}>
                      <CheckCircle className="h-3 w-3" />
                      <span>Upper and lowercase letters</span>
                    </div>
                    <div className={`flex items-center space-x-2 ${passwordValidation.hasNumber ? 'text-success' : 'text-muted-foreground'}`}>
                      <CheckCircle className="h-3 w-3" />
